...
<body>
  ...
  <main id="main" style="margin-top: -10vh;">
    ...
    <section id="events" class="events">
      ...
      <div class="container">
      <h1 style="color: white; text-align: center;"><span style="color:#FFB03B">Welcome to </span>  MANGALORE</h1>
          ...
          <div class="row">
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                      <div class="thumb">
                          <img src="https://wallpapershome.com/images/pages/ico_h/3171.jpg" alt="">
                      </div>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                      <div class="thumb">
                          <img src="https://wallpapershome.com/images/pages/ico_h/6498.jpg" alt="">
                      </div>
                      <div class="place_info">
                          <h3>Goldfinch Hotel</h3>
                          <p>Mangalore</p>
                          <div class="rating_days d-flex justify-content-between">
                              <span class="d-flex justify-content-center align-items-center">
                                   <i class="fa fa-star" style="color: #FDAE5C;"></i>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                      <div class="thumb">
                          <img src="https://wallpapershome.com/images/pages/ico_h/16232.jpg" alt="">
                      </div>
                      <div class="place_info">
                          <h3>Hotel Sai Palace</h3>
                          <p>Mangalore</p>
                          <div class="rating_days d-flex justify-content-between">
                              <span class="d-flex justify-content-center align-items-center">
                                   <i class="fa fa-star" style="color: #FDAE5C;"></i>
